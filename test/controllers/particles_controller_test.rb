...
class ParticlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create particle" do
    assert_difference('Particle.count') do
      post particles_url, params: { particle: { body: @particle.body, title: @particle.title } }
    end
  ...
  test "should update particle" do
    patch particle_url(@particle), params: { particle: { body: @particle.body, title: @particle.title } }
